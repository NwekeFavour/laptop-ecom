            ...
            <section className="bg-gray-50 dark:bg-gray-900">
                <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 grid lg:grid-cols-2 gap-8 lg:gap-16">
                    <div className="flex flex-col justify-center">
                        ...
                        <p className="mb-6 text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-400">Discover Your Perfect Laptop
                    ...
                    <div>                        
                        {
                            toRegister ? 
                                <div className="w-full lg:max-w-xl p-6 space-y-8 sm:p-8 bg-white rounded-lg shadow-xl dark:bg-gray-800">
                                    ...
                                    <form onSubmit={sendData} className="mt-8 space-y-6" action="#">
                                        <div>
                                        ...
                                        <div className="text-sm font-medium text-gray-900 dark:text-white">
                                            Not registered yet? <a onClick={setToRegister} className="text-blue-600 hover:underline dark:text-blue-500 cursor-pointer">Create account</a>
                                        </div>
                                    </form>
                                </div>
                                    
                                    : 
                            <Register title="Sign in to Flowbite"/>
                        }
                    </div>
                </div>
            </section>
