            ...
            <footer className="p-4 sm:p-6 bg-gray-800">
                <div className="mx-auto max-w-screen-xl">
                        ...
                        <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                            <div>
                                ...
                                <ul className="text-gray-600 dark:text-gray-400">
                                    <li className="mb-4">
                                        <a href="https://flowbite.com" className="hover:underline">Plugs</a>
                                    </li>
                                    <li>
                                        <a href="https://tailwindcss.com/" className="hover:underline">Plugs upon Plugs</a>
                                    </li>
                                </ul>
                            </div>
                            <div>
                    ...
                    <div className="sm:flex sm:items-center sm:justify-between">
                        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="https://flowbite.com" className="hover:underline">{props.name}</a>. All Rights Reserved.
                        </span>
